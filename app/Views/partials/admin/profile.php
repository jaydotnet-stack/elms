    ...
    <div class="card radius-15">
        <div class="card-body">
            <div class="card-title">
                <h4 class="mb-0">Lecturer Profile</h4>
            </div>
            <hr/>
					<!--breadcrumb-->
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						<div class="breadcrumb-title pr-3">Lecturer</div>
						<div class="pl-3">
									...
									<div class="col-12 col-lg-7 border-right">
										<div class="d-md-flex align-items-center">
											<div class="mb-md-0 mb-3">
												<img src="<?= base_url(); ?>adminassets/images/avatars/avatar-1.png" class="rounded-circle shadow" width="130" height="130" alt="" />
											</div>
									...
									<div class="col-12 col-lg-5">
										<table class="table table-sm table-borderless mt-md-0 mt-3">
											<tbody>
												<tr>
													<th>Post:</th>
													<td>Assistant Lecturer <span class="badge badge-success">available</span>
													</td>
												</tr>
												<tr>
													<th>Location:</th>
																...
																<div class="row">
																		...
																		<div class="card shadow-none border mb-3 mb-md-0">
																			<div class="card-body">
																				<div class="media align-items-center">
																					<img src="<?= base_url(); ?>adminassets/images/icons/credit-card-visa.png" width="50" alt="">
																	...
																	<div class="col-12 col-lg-6">
																		<div class="card shadow-none border mb-0">
																			<div class="card-body">
																				<div class="media align-items-center">
																					<img src="<?= base_url(); ?>adminassets/images/icons/mastercard-2.png" width="50" alt="">
																					<div class="media-body ml-2">
													...
													<div class="media-body ml-3">
														...
														<div class="row">
															<div class="col-12 col-lg-3">
																<img src="<?= base_url(); ?>adminassets/images/gallery/35.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="<?= base_url(); ?>adminassets/images/gallery/36.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="<?= base_url(); ?>adminassets/images/gallery/37.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="<?= base_url(); ?>adminassets/images/gallery/38.jpg" class="img-thumbnail" alt="">
															</div>
														</div>
														<hr/>
													</div>
