<button style='display:none' type="button" class="btn btn-primary" id='modalTriggerYesNoBtn' data-toggle="modal"   data-target="#modalTriggerYesNo">Register</button>

<!-- Modal -->
<div class="modal fade" id="modalTriggerYesNo" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= APP_NAMESPACE; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">	<span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id='modalBody' style='font-size:15px;font-weight:bold'></div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id='yesNoBtn' value='0'>Save changes</button>
...
<button style='display:none' type="button" class="btn btn-primary" id='modalErrorBtn' data-toggle="modal"   data-target="#modalError">Register</button>
...
<div class="modal fade" id="modalError" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id='modalErrorBody' style='color:red;font-size:15px;font-weight:bold'></div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content radius-30">
            ...
            <div class="modal-body p-5">
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-primary radius-30 btn-lg btn-block">Sign In</button>
                </div>
